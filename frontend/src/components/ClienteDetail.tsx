...
type ClienteFormProps = {
  onEditChange: (value: boolean) => void; // Função para notificar o pai ao ativar edição
...
// =========================
// Componente ClienteDetails
// =========================
export default function ClienteDetails({ isOpen, onClose, onEditChange }: ClienteFormProps) {
  // Pega o primeiro cliente do mock (substituir por fetch real se necessário)
  ...
  // =========================
  // Funções auxiliares para cores de status e prioridade
  // =========================
  ...
  // Ativar edição via botão
  const handleActiveEdit = () => {
    onEditChange(true);
  };

  // =========================
  // Renderização do Modal com AnimatePresence
  // =========================
  return (
    <AnimatePresence>
      {isOpen && (
